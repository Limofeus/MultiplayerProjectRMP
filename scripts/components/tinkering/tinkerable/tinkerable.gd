extends InteractionReceivingComponent #Extends InteractionRespondingComponent to be able to quickly use it's functionaliity, when godot traits(interfaces) will come, I'll rewrite that probably
